  ...
  return (
    <div className="bg-white rounded-xl overflow-hidden shadow-elevated border border-border">
      <div className="p-4 bg-secondary/50 flex justify-between items-center">
        ...
        <span className="px-2 py-1 bg-primary/10 text-primary text-xs rounded-full">4 Stores</span>
      </div>
          ...
          >
            ...
            <div className="divide-y divide-border/50">
              {item.prices.map((storePrice, priceIdx) => (
                <div key={priceIdx} className="flex items-center justify-between px-4 py-2">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm">{storePrice.store}</span>
                  </div>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    {storePrice.isLowest && (
                      <span className="text-xs px-2 py-0.5 bg-primary/10 text-primary rounded-full">Best Price</span>
                    )}
                  </div>
                </div>
              ))}
